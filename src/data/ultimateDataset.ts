...
export const tournamentField2026 = [
  ...
  { id: 'idaho', name: 'Idaho', seed: 15, region: 'South', record: '21-14', kenPomRank: 115, adjOE: 101.8, adjDE: 111.5, tempo: 65.8, conference: 'Big Sky', injuries: [], momentum: 'neutral' },
  { id: 'lehigh', name: 'Lehigh', seed: 16, region: 'South', record: '18-14', kenPomRank: 148, adjOE: 98.2, adjDE: 114.8, tempo: 68.2, conference: 'Patriot', injuries: [], momentum: 'neutral' },
  { id: 'prairie-view', name: 'Prairie View', seed: 16, region: 'South', record: '17-15', kenPomRank: 155, adjOE: 97.5, adjDE: 115.5, tempo: 69.5, conference: 'SWAC', injuries: [], momentum: 'neutral' },
  
  // MIDWEST REGION - CORRECTED FROM ESPN
  ...
  { id: 'iowa-state', name: 'Iowa State', seed: 2, region: 'Midwest', record: '22-10', kenPomRank: 6, adjOE: 120.2, adjDE: 94.8, tempo: 65.8, conference: 'Big 12', injuries: [], momentum: 'hot' },
  { id: 'virginia', name: 'Virginia', seed: 3, region: 'Midwest', record: '25-7', kenPomRank: 10, adjOE: 118.5, adjDE: 96.2, tempo: 62.5, conference: 'ACC', injuries: [], momentum: 'neutral' },
  { id: 'alabama', name: 'Alabama', seed: 4, region: 'Midwest', record: '22-10', kenPomRank: 14, adjOE: 117.2, adjDE: 97.5, tempo: 72.5, conference: 'SEC', injuries: [], momentum: 'hot' },
  ...
  { id: 'tennessee', name: 'Tennessee', seed: 6, region: 'Midwest', record: '24-8', kenPomRank: 21, adjOE: 115.5, adjDE: 99.5, tempo: 65.8, conference: 'SEC', injuries: [], momentum: 'neutral' },
  { id: 'kentucky', name: 'Kentucky', seed: 7, region: 'Midwest', record: '25-7', kenPomRank: 25, adjOE: 114.2, adjDE: 100.8, tempo: 71.8, conference: 'SEC', injuries: [], momentum: 'neutral' },
  { id: 'georgia', name: 'Georgia', seed: 8, region: 'Midwest', record: '22-10', kenPomRank: 30, adjOE: 113.5, adjDE: 101.5, tempo: 70.8, conference: 'SEC', injuries: [], momentum: 'hot' },
  { id: 'saint-louis', name: 'Saint Louis', seed: 9, region: 'Midwest', record: '28-5', kenPomRank: 33, adjOE: 112.8, adjDE: 102.5, tempo: 68.5, conference: 'A-10', injuries: [], momentum: 'hot' },
  { id: 'santa-clara', name: 'Santa Clara', seed: 10, region: 'Midwest', record: '26-8', kenPomRank: 41, adjOE: 111.8, adjDE: 103.5, tempo: 69.5, conference: 'WCC', injuries: [], momentum: 'neutral' },
  ...
  { id: 'hofstra', name: 'Hofstra', seed: 13, region: 'Midwest', record: '23-9', kenPomRank: 75, adjOE: 108.2, adjDE: 107.8, tempo: 69.5, conference: 'CAA', injuries: [], momentum: 'neutral' },
  { id: 'wright-state', name: 'Wright St', seed: 14, region: 'Midwest', record: '23-11', kenPomRank: 82, adjOE: 106.5, adjDE: 109.2, tempo: 69.5, conference: 'Horizon', injuries: [], momentum: 'hot' },
  { id: 'tennessee-state', name: 'Tennessee St', seed: 15, region: 'Midwest', record: '23-9', kenPomRank: 105, adjOE: 103.2, adjDE: 111.8, tempo: 63.8, conference: 'OVC', injuries: [], momentum: 'neutral' },
