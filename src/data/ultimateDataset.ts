...
export const tournamentField2026 = [
  ...
  { id: 'georgia', name: 'Georgia', seed: 5, region: 'Midwest', record: '22-10', kenPomRank: 19, adjOE: 116.5, adjDE: 98.2, tempo: 70.8, conference: 'SEC', injuries: [], momentum: 'hot' },
  ...
  { id: 'wright-state', name: 'Wright State', seed: 13, region: 'Midwest', record: '23-11', kenPomRank: 75, adjOE: 108.2, adjDE: 107.8, tempo: 69.5, conference: 'Horizon', injuries: [], momentum: 'hot' },
  { id: 'tennessee-state', name: 'Tennessee State', seed: 14, region: 'Midwest', record: '23-9', kenPomRank: 82, adjOE: 106.5, adjDE: 109.2, tempo: 63.8, conference: 'OVC', injuries: [], momentum: 'neutral' },
